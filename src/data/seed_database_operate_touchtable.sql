...
INSERT INTO "DATA_SET_MAPPING" (visualization_id, data_set) VALUES (
    ...
    '{"title": "Documents Received", "count": 12}'
);
INSERT INTO "DATA_SET_MAPPING" (visualization_id, data_set) VALUES (
    ...
    '{"documents": [{"id": 1, "name": "Loan Agreement", "description": "Primary loan agreement document outlining terms and conditions", "type": "pdf", "filename": "Banking_Capital_Market_Operate_Table_Loan_Agreement.pdf"}, {"id": 2, "name": "Financial Statement", "description": "Company financial statements and performance metrics", "type": "pdf", "filename": "Banking_Capital_Market_Operate_Table_2024_Q2_Financials.pdf"}, {"id": 3, "name": "Covenant Summary", "description": "Summary of loan covenants and compliance tracking", "type": "xlsx", "filename": "Banking_Capital_Market_Operate_Table_Covenant_Summary.xlsx"}, {"id": 4, "name": "ESG Report 02", "description": "Environmental, Social, and Governance report", "type": "pdf", "filename": "Banking_Capital_Market_Operate_Table_ESG_Report_Q2.pdf"}, {"id": 5, "name": "FR Y-14 Analysis", "description": "Federal Reserve Y-14 regulatory analysis and reporting", "type": "pdf", "filename": "Banking_Capital_Market_Operate_Table_Fleet_Lease_Agreements.pdf"}, {"id": 6, "name": "Risk Assessment", "description": "Comprehensive risk assessment document", "type": "docx", "filename": "Banking_Capital_Market_Operate_Table_Risk_Assessment.docx"}, {"id": 7, "name": "Balance Sheet", "description": "Company balance sheet and financial position", "type": "xlsx", "filename": "Banking_Capital_Market_Operate_Table_Balance_Sheet.xlsx"}, {"id": 8, "name": "Quarterly Report", "description": "Quarterly financial and operational report", "type": "pdf", "filename": "Banking_Capital_Market_Operate_Table_Quarterly_Report.pdf"}, {"id": 9, "name": "Compliance Certificate", "description": "Compliance certification and regulatory documentation", "type": "pdf", "filename": "Banking_Capital_Market_Operate_Table_Compliance_Certificate.pdf"}, {"id": 10, "name": "Market Analysis", "description": "Market analysis and industry trends presentation", "type": "pptx", "filename": "Banking_Capital_Market_Operate_Table_Market_Analysis.pptx"}, {"id": 11, "name": "Credit Approval", "description": "Credit approval documentation and decision rationale", "type": "pdf", "filename": "Banking_Capital_Market_Operate_Table_Credit_Approval.pdf"}, {"id": 12, "name": "Facility Agreement", "description": "Facility agreement terms and conditions", "type": "pdf", "filename": "Banking_Capital_Market_Operate_Table_Facility_Agreement.pdf"}]}'
);
INSERT INTO "DATA_SET_MAPPING" (visualization_id, data_set) VALUES (
...
INSERT INTO "DATA_SET_MAPPING" (visualization_id, data_set) VALUES (
    ...
    '{"title": "", "success_message": "You''ve successfully created your personalized loan journey.", "qr_code_url": "https://www.ey.com", "options": [{"type": "delivery", "label": "Delivery options", "choices": ["Email", "SMS"]}, {"type": "rating", "label": "Rate us"}], "submit_label": "Submit", "cta_label": "Back to home", "cta_target": "/"}'
);
