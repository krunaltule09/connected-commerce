...
export default function CovenantBreachLog({ documents }) {
  ...
  return (
    <LogContainer>
      ...
      <AlertBox>
        <Box component="img" src={ASSETS.ALERT_ICON} alt="Alert Icon" sx={{ width: 20, height: 20, flexShrink: 0 }} />
        ...
        {documents.map((doc) => (
          <Grid item xs={12} sm={4} key={doc.id}>
            <DocumentCard elevation={0}>
              <DocumentHeader>
                <Box component="img" src={ASSETS.LIGHT_CIRCLE_OUTLINE} alt="Document Icon" sx={{ width: 28, height: 28, flexShrink: 0 }} />
                <Box>
              ...
              <DocumentFooter>
                <ViewButton>
                  View
                  <Box component="img" src={ASSETS.ARROW_ICON} alt="Arrow Icon" sx={{ width: 7, height: 12, ml: 0.5, mt: 0.25 }} />
                </ViewButton>
              </DocumentFooter>
            </DocumentCard>
          </Grid>
