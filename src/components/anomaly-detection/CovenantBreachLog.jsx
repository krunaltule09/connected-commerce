        ...
        {documents.map((doc) => (
          <Grid item xs={12} sm={4} key={doc.id}>
            <DocumentCard elevation={0}>
              <DocumentHeader>
                <Box component="img" src={assets['Banking_Capital_Market_Operate_Table_Light_Circle_Outline.svg']} alt="Document Icon" sx={{ width: 28, height: 28, flexShrink: 0 }} />
                <Box>
              ...
              <DocumentFooter>
                <ViewButton>
                  View
                  <Box component="img" src={assets['Banking_Capital_Market_Operate_Table_Arrow_Icon.svg']} alt="Arrow Icon" sx={{ width: 7, height: 12, ml: 0.5, mt: 0.25 }} />
                </ViewButton>
              </DocumentFooter>
            </DocumentCard>
          </Grid>
