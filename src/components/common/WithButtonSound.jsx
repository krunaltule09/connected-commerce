 ...
 */
const WithButtonSound = (Component, soundPath = ASSETS.BUTTON_CLICK) => {
 ...
 */
export const useSoundClick = (onClick, soundPath = ASSETS.BUTTON_CLICK) => {
  const playSound = useSound(soundPath, { volume: 0.5 });
 ...
 */
export const SoundButton = ({ element, soundPath = ASSETS.BUTTON_CLICK }) => {
